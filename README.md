...
Основной сценарий приложения построен вокруг ежедневного плана:

1. повторить карточки, которым подошёл срок;
2. добавить небольшую порцию новых слов;
3. закончить короткой практикой тонов.

Импорт и управление наборами находятся в разделе «Мои карточки», а подробная статистика — в разделе «Прогресс».
...
Перед фиксацией изменений можно проверить типы и production-сборку одной командой:
